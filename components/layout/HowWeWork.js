...
const HowWeWork = () => {
  return (
    <div className="my-28 lg:py-28 mx-auto container f-f-p px-4 xl:px-0">
      ...
      <div className="md:mt-24 f-f-p">
        ...
        <div className="md:hidden flex flex-col items-center w-full">
          ...
          <div className="mt-10 px-5">
            <h1 className="text-2xl tracking-wide font-semibold">Seguridad</h1>
            <h2 className="text-colo-para mt-3 text-base leading-6 tracking-wide">
              En Rutas Panamá practicamos y compartimos la pasión por la
              seguridad y la consideramos como un factor clave durante la
              prestación de nuestros servicios de transporte, logrando un
          ...
          <div className="flex px-5 mt-10 flex-col md:items-start md:w-8/12">
            <h1 className="text-2xl tracking-wide font-semibold">
              Atención 365
            </h1>
            <h2 className="text-colo-para mt-3 text-base leading-6 tracking-wide">
